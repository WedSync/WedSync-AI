-- WARNING: This migration references tables that may not exist: workflow_tasks, task_comments, team_members, task_templates, template_tasks, checklist_templates, timeline_templates, weddings
