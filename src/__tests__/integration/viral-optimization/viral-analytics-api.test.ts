...
vi.mock('@/lib/services/viral-analytics-service', () => ({
  ViralAnalyticsService: {
    analyzeGenerations: vi.fn(),
    analyzeChannelPerformance: vi.fn(),
    analyzeOptimalTiming: vi.fn(),
    analyzeGeographicSpread: vi.fn(),
    analyzeViralCohorts: vi.fn(),
    getViralAnalyticsSummary: vi.fn()
// Mock data
