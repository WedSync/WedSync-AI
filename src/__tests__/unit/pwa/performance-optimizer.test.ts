...
describe('PWAPerformanceOptimizer', () => {
  ...
  let mockCacheManager: ReturnType<typeof vi.fn>ed<PWACacheManager>;
  let mockStorageOptimizer: ReturnType<typeof vi.fn>ed<PWAStorageOptimizer>;
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  beforeEach(() => {
    ...
    test('should not start optimization if already in progress', async () => {
      ...
      (performanceOptimizer as unknown).isOptimizing = true;
  ...
  beforeEach(() => {
    ...
    test('should assess offline capabilities', async () => {
      ...
      const capabilities = await (performanceOptimizer as unknown).assessOfflineCapabilities();
    ...
    test('should calculate offline capability score', async () => {
      ...
      const score = await (performanceOptimizer as unknown).calculateOfflineCapabilityScore();
  ...
  beforeEach(() => {
    ...
    test('should calculate critical data availability', async () => {
      ...
      const availability = await (performanceOptimizer as unknown).calculateCriticalDataAvailability();
  ...
  beforeEach(() => {
    ...
    test('should calculate user experience score', async () => {
      // Set up good metrics
        hitRate: 90
      const score = await (performanceOptimizer as unknown).calculateUserExperienceScore();
  ...
  beforeEach(() => {
    ...
    test('should preload wedding timeline', async () => {
      await (performanceOptimizer as unknown).preloadWeddingTimeline('wedding-123', ['ceremony']);
        { events: ['ceremony'] },
          dataType: WeddingDataType.TIMELINE
    test('should preload critical vendors', async () => {
      await (performanceOptimizer as unknown).preloadCriticalVendors('wedding-123', ['vendor-1']);
        'wedding:wedding-123:vendor:vendor-1',
        { name: 'Vendor' },
          dataType: WeddingDataType.VENDORS
    test('should preload emergency contacts', async () => {
      await (performanceOptimizer as unknown).preloadEmergencyContacts(['contact-1']);
        'emergency:contacts',
        [{ name: 'Emergency' }],
    ...
    test('should handle preload errors gracefully', async () => {
      ...
      await expect((performanceOptimizer as unknown).preloadWeddingTimeline('wedding-123', ['ceremony']))
