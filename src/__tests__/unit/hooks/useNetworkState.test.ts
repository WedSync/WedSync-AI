...
describe('useNetworkState', () => {
  ...
  describe('error handling', () => {
    it('should handle network monitor initialization failure', () => {
      (NetworkMonitor as ReturnType<typeof vi.fn>).mockImplementation(() => {
  ...
  describe('performance and optimization', () => {
    it('should not create new network monitor instance on re-renders', () => {
      ...
      const initialCallCount = (NetworkMonitor as ReturnType<typeof vi.fn>).mock.calls.length;
      // Re-render multiple times
      expect((NetworkMonitor as ReturnType<typeof vi.fn>).mock.calls.length).toBe(initialCallCount);
