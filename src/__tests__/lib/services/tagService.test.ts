...
const mockSupabase = supabase as ReturnType<typeof vi.fn>ed<typeof supabase>
describe('TagService', () => {
  ...
  describe('getTags', () => {
    it('retrieves tags with filters', async () => {
      const mockTags = [
        ...
        range: vi.fn().mockResolvedValue({ data: mockTags, error: null })
      const options = {
  ...
  describe('deleteTag', () => {
    ...
    it('deletes tag and associations successfully', async () => {
      ...
      mockSupabase.from
        .mockReturnValueOnce(mockClientTagsQuery as unknown) // client_tags
        .mockReturnValueOnce(mockTagsQuery as unknown) // tags
  ...
  describe('addTagsToClient', () => {
    ...
    it('adds tags to client successfully', async () => {
      ...
      const mockUsageQuery = {
        eq: vi.fn().mockResolvedValue({ data: [1, 2], error: null })
      const mockUpdateQuery = {
        update: vi.fn().mockReturnThis(),
        .mockReturnValueOnce(mockValidationQuery as unknown) // validation
        .mockReturnValueOnce(mockAssociationQuery as unknown) // associations
        .mockReturnValue(mockUsageQuery as unknown) // usage counts (multiple calls)
  ...
  describe('bulkTagOperation', () => {
    ...
    it('performs bulk add operation', async () => {
        ...
        .mockReturnValueOnce(mockQuery as unknown)
        .mockReturnValue(mockUsageQuery as unknown)
