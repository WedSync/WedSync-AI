...
vi.mock('@/lib/security/payment-security');
// Mock fetch
global.fetch = vi.fn();
...
describe('PaymentCalendarService', () => {
  ...
  let mockSecurityManager: ReturnType<typeof vi.fn>ed<PaymentSecurityManager>;
  beforeEach(() => {
    vi.clearAllMocks();
    
    service = new PaymentCalendarService();
    mockSecurityManager = new PaymentSecurityManager() as ReturnType<typeof vi.fn>ed<PaymentSecurityManager>;
