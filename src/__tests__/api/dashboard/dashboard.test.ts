...
const mockDashboardService = DashboardService as ReturnType<typeof vi.fn>edClass<typeof DashboardService>
...
describe('Dashboard API', () => {
  ...
  describe('GET /api/dashboard', () => {
    it('should return dashboard data for authenticated user', async () => {
      ...
      mockDashboardService.mockImplementation(() => mockServiceInstance as unknown)
      // Create test request
    ...
    it('should handle service errors gracefully', async () => {
        getDashboardData: vi.fn().mockRejectedValue(new Error('Database connection failed')),
  ...
  describe('POST /api/dashboard', () => {
    ...
    it('should refresh metrics successfully', async () => {
      mockSupabaseClient.rpc.mockResolvedValue({
        data: null,
        invalidateCache: vi.fn().mockResolvedValue(5)
    ...
    it('should invalidate cache successfully', async () => {
        invalidateCache: vi.fn().mockResolvedValue(10)
