...
export function OutlookEventMapping({
  ...
  const [activeTab, setActiveTab] = useState<'mappings' | 'conflicts'>(
    'mappings',
  );
  const [selectedConflict, setSelectedConflict] =
    useState<EventConflict | null>(null);
  ...
  const handleMappingUpdate = useCallback(
    (mappingId: string, updates: Partial<MappingType>) => {
  ...
  const getEventTypeInfo = (type: WeddingEventType) => {
    return (
      weddingEventTypes.find((t) => t.value === type) || weddingEventTypes[0]
    );
  };
        ...
        <nav className="-mb-px flex space-x-8">
          ...
          >
            ...
            {mockConflicts.length > 0 && (
              <Badge className="ml-2 bg-error-500 text-white text-xs">
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <Select
                        ...
                        onValueChange={(value) =>
                          handleMappingUpdate(mapping.id, {
                            outlookCategory: value,
                          })
                        }
                      >
                        <SelectTrigger>
              ...
              <div className="flex justify-end space-x-3 pt-4 border-t">
                <Button
                  ...
                  onClick={() => {
                    ...
                    const defaultMappings = mappings.map((m) => ({
                      ...m,
                      outlookCategory: 'Business',
            ...
            <Card>
              <CardContent className="text-center py-12">
                ...
                <p className="text-gray-600">
                  All your events are synchronized without conflicts.
                </p>
              </CardContent>
            </Card>
          ) : (
              ...
              <Card>
                <CardHeader>
                  <div className="flex items-center justify-between">
                    <div>
                      <CardTitle>
                        Event Conflicts ({mockConflicts.length})
                      </CardTitle>
                      <CardDescription>
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center space-x-2 mb-2">
                            <Badge
                              className={`${getConflictSeverityColor(conflict.severity)} border text-xs`}
                            >
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="space-y-1">
                              ...
                              <p className="text-sm text-gray-600">
                                {new Date(
                                  conflict.sourceEvent.start,
                                ).toLocaleString()}{' '}
                                -{' '}
                                {new Date(
                                  conflict.sourceEvent.end,
                                ).toLocaleString()}
                              </p>
                              <p className="text-sm text-gray-500">
                                {conflict.sourceEvent.location}
                              </p>
                            </div>
                            ...
                            <div className="space-y-1">
                              ...
                              <p className="text-sm text-gray-600">
                                {new Date(
                                  conflict.conflictingEvent.start,
                                ).toLocaleString()}{' '}
                                -{' '}
                                {new Date(
                                  conflict.conflictingEvent.end,
                                ).toLocaleString()}
                              </p>
                              <p className="text-sm text-gray-500">
                    ...
                    {selectedConflict.suggestedResolution && (
                      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                        ...
                        <p className="text-blue-800 mb-3">
                          {selectedConflict.suggestedResolution.action}
                        </p>
                        ...
                        <div className="mt-3">
                          ...
                          <ul className="text-sm text-blue-800 space-y-1">
                            {selectedConflict.suggestedResolution.impact.map(
                              (impact, index) => (
