...
export function NotificationPreferences({
  ...
  const sendTestNotification = async (category: string) => {
    setTestMode(true);
    try {
      await pushNotificationSystem.sendNotification(userId, 'SYSTEM_ALERT', {
        title: `Test ${category} Notification`,
        body: 'This is a test notification. If you see this, notifications are working!',
        icon: '/icons/notification-icon.png',
        badge: '/icons/badge-icon.png',
        vibrate: preferences?.vibrationSettings.enabled
          ? preferences.vibrationSettings.pattern
          : undefined,
      });
    } catch (error) {
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-red-700 dark:text-red-300 mt-1">
                ...
                them in your browser settings to receive notifications.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm">
        <div className="flex items-center justify-between mb-6">
          ...
          <Switch
            ...
            onCheckedChange={(checked) =>
              updatePreference(['globalEnabled'], checked)
            }
          />
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            ...
            <button
              onClick={() =>
                updatePreference(['channels', 'sms'], !preferences.channels.sms)
              }
              className={cn(
                'p-3 rounded-lg border transition-all',
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  updatePreference(['soundSettings', 'enabled'], checked)
                }
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  updatePreference(['vibrationSettings', 'enabled'], checked)
                }
              />
            </div>
          </div>
                          ...
                          {setting.type === 'toggle' && (
                            <Switch
                              ...
                              onCheckedChange={(checked) => {
                                ...
                                const categoryKey =
                                  category.id as keyof typeof preferences.categories;
                                updatePreference(
                                  [
                                    'categories',
                                    categoryKey,
                                    setting.id.replace(`${category.id}_`, ''),
                                  ],
                                  checked,
                                );
                              }}
