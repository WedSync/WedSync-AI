...
export default function EnterpriseProviderSelector({
  ...
  const [selectedProvider, setSelectedProvider] =
    useState<SSOProviderConfig | null>(null);
            ...
            >
              ...
              <CardContent className="space-y-3">
                <div className="text-sm text-muted-foreground">
                  <p>
                    <strong>{provider.userCount}</strong> users authenticated
                  </p>
                  {provider.domains.length > 0 && (
                    <p>
                      <strong>Domains:</strong> {provider.domains.join(', ')}
                    </p>
                  )}
                  {provider.lastSync && (
                    <p>
      ...
      {showAddProvider && !readonly && (
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <Alert>
              <AlertDescription>
                🎊 <strong>Wedding Business Tip:</strong> Most wedding venues
                and suppliers use Microsoft or Google for email. SAML is
                typically used by larger venue chains and enterprise photography
                studios.
              </AlertDescription>
            </Alert>
