...
export default function BrandingCustomizer({
  ...
  const handleFieldChange = useCallback(
    (field: keyof CreateBrandRequest, value: string) => {
  ...
  const handleFileUpload = useCallback(
    async (e: React.ChangeEvent<HTMLInputElement>, type: 'logo' | 'banner') => {
      ...
      if (!allowedTypes.includes(file.type)) {
        setErrors((prev) => ({
          ...prev,
          [type]: 'Only JPEG, PNG, SVG, and WebP files are allowed',
        }));
        return;
      }
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-gray-600">
              Customize your brand appearance across WedSync
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e) =>
                  handleFieldChange('brandGuidelines', e.target.value)
                }
                rows={3}
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            >
              ...
              <div className="p-6 bg-white">
                ...
                <p className="text-gray-600 mb-4">
                  Manage your wedding planning with style using your custom
                  brand.
                </p>
