...
export function FlowerSearch({
  ...
  const addColor = (color: string) => {
    if (
      ...
      searchCriteria.colors.length < 5
    ) {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-3">
            ...
            <Select
              ...
              onChange={(value) =>
                setSearchCriteria((prev) => ({ ...prev, style: value }))
              }
              className="w-full"
            >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="space-y-3">
                ...
                <Select
                  ...
                  onChange={(value) =>
                    setSearchCriteria((prev) => ({ ...prev, season: value }))
                  }
                  className="w-full"
                >
                  {SEASONS.map((season) => (
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-3">
                  <Slider
                    value={[
                      searchCriteria.budget_range.min,
                      searchCriteria.budget_range.max,
                    ]}
              ...
              <div className="space-y-3">
                ...
                <div className="text-sm text-gray-600">
                  {searchCriteria.sustainability_minimum === 0
                    ? 'No preference'
                    : searchCriteria.sustainability_minimum < 0.3
                      ? 'Low priority'
                      : searchCriteria.sustainability_minimum < 0.7
                        ? 'Moderate priority'
                        : 'High priority'}
                </div>
              </div>
          ...
          <div className="flex items-center justify-between">
            ...
            {searchResults.search_metadata?.avg_seasonal_score && (
              <div className="text-sm text-gray-600">
                Avg Seasonal Score:{' '}
                {(
                  searchResults.search_metadata.avg_seasonal_score * 100
                ).toFixed(0)}
                %
              </div>
            )}
            ...
            {searchResults.flowers?.map((flower: any, index: number) => (
              ...
              >
                <div className="space-y-3">
                  ...
                  {flower.matched_color && (
                    <div className="flex items-center gap-2">
                      <div
                        ...
                        style={{
                          backgroundColor: flower.matched_color.color_hex,
                        }}
                  ...
                  {/* Seasonal Notes */}
                  {flower.seasonal_notes &&
                    flower.seasonal_notes.length > 0 && (
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3">
              ...
              <p className="text-sm text-red-700 mt-1">
                {error.message ||
                  'An error occurred while searching for flowers. Please try again.'}
              </p>
            </div>
          </div>
        </div>
