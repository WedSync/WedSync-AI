...
export function NodeConfigPanel({
  ...
  return (
    <div
      className={cn(
        'w-80 bg-card border-l flex-shrink-0 flex flex-col',
        className,
      )}
    >
      {/* Header */}
            ...
            <CardHeader className="pb-3">
              <CardTitle className="text-sm flex items-center justify-between">
                <span>
                  {
                    nodeTypeLabels[
                      selectedNode.type as keyof typeof nodeTypeLabels
                    ]
                  }
                </span>
                <Badge
            ...
            <CardContent className="space-y-3">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleBasicInfoChange('label', e.target.value)
                  }
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-md bg-background text-foreground text-sm focus:outline-none focus:ring-2 focus:ring-ring resize-none"
                  rows={2}
