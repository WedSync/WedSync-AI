  ...
  return (
    <div
      ...
      style={{
        ...
        transition:
          'transform 0.2s cubic-bezier(0.4, 0, 0.2, 1), opacity 0.3s ease',
      }}
    >
      {/* Selection Highlight */}
...
export const CursorActivityIndicator: React.FC<
  CursorActivityIndicatorProps
> = ({ activeCursors, className = '' }) => {
...
if (
  ...
  !document.getElementById('cursor-animations')
) {
