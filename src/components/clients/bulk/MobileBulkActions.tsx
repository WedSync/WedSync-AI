...
const EMAIL_TEMPLATES = [
  {
    ...
    description: 'Request wedding day timeline details',
  },
  {
    id: 'payment_reminder',
    label: 'Payment Reminder',
    description: 'Remind about outstanding payments',
  },
  {
    id: 'final_details',
    label: 'Final Details',
    description: 'Pre-wedding final details check',
  },
  {
    id: 'custom',
    label: 'Custom Email',
...
const FORM_TEMPLATES = [
  {
    id: 'timeline_form',
    label: 'Timeline Form',
    description: 'Wedding day timeline questionnaire',
  },
  {
    id: 'details_form',
    label: 'Details Form',
    description: 'Wedding details collection form',
  },
  {
    id: 'preferences_form',
    label: 'Preferences Form',
    description: 'Photography preferences form',
  },
];
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-3 px-4 py-4 border-b border-gray-200">
          ...
          <div
            className={`w-10 h-10 ${selectedAction.color} rounded-lg flex items-center justify-center`}
          >
              ...
              <div className="space-y-2">
                {FORM_TEMPLATES.map((form) => (
                  <button
                    key={form.id}
                    onClick={() =>
                      setConfiguration({ ...configuration, form: form.id })
                    }
                    className={`w-full text-left p-3 rounded-lg border transition-all ${
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {STATUS_OPTIONS.map((status) => (
                  ...
                  >
                    <div
                      className={`w-3 h-3 rounded-full ${status.color.split(' ')[0]}`}
                    />
