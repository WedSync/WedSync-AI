...
export function MFASettings({ userId }: MFASettingsProps) {
  ...
  const hasVerifiedFactors = allFactors.some(
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Protect your wedding vendor contracts and client data with an
        ...
        <CardContent className="space-y-6">
          ...
          {!hasVerifiedFactors && (
            <Alert>
              ...
              <AlertDescription>
                <strong>Protect $500K+ in vendor contracts!</strong> Enable
                two-factor authentication to secure your wedding planning data,
                vendor payments, and private client information.
              </AlertDescription>
            </Alert>
          )}
      ...
      <Dialog open={showRemoveDialog} onOpenChange={setShowRemoveDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to remove this authentication method? You'll
              need to set it up again if you want to use it in the future.
            </DialogDescription>
          </DialogHeader>
          {factorToRemove && (
            <div className="py-4">
              <div className="flex items-center gap-3 p-3 bg-muted rounded-lg">
                ...
                <div>
                  <div className="font-medium text-sm">
                    {factorToRemove.friendlyName ||
                      getFactorName(factorToRemove.factorType)}
                  </div>
