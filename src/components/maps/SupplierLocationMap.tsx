...
export default function SupplierLocationMap({
  ...
  const [selectedSupplier, setSelectedSupplier] = useState<MapSupplier | null>(
    null,
  );
  ...
  const handleMarkerClick = useCallback(
    (supplier: MapSupplier) => {
      ...
      setInfoWindowPosition(
        new google.maps.LatLng(supplier.latitude, supplier.longitude),
      );
    ...
    (supplier: MapSupplier) => {
      ...
      return {
        ...
        <svg width="32" height="40" viewBox="0 0 32 40" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          ${
            supplier.isVerified
              ? '<path d="M12 16L14.5 18.5L20 13" stroke="' +
                baseColor +
        ...
        <div className="p-2 max-w-xs">
          <div className="flex items-start gap-3">
            <Avatar className="h-12 w-12 flex-shrink-0">
              <AvatarImage
                src={selectedSupplier.featuredImage}
              ...
              <CardContent className="p-0 space-y-4">
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <Label htmlFor="service-areas" className="text-xs">
                      Service Areas
                    </Label>
                    <Switch
                      id="service-areas"
                      ...
                      onCheckedChange={(checked) =>
                        updateSettings({ showServiceAreas: checked })
                      }
                    />
                  </div>

                  <div className="flex items-center justify-between">
                    <Label htmlFor="search-radius" className="text-xs">
                      Search Radius
                    </Label>
                    <Switch
                      id="search-radius"
                      ...
                      onCheckedChange={(checked) =>
                        updateSettings({ showSearchRadius: checked })
                      }
                    />
                  </div>

                  <div className="flex items-center justify-between">
                    <Label htmlFor="traffic" className="text-xs">
                      Traffic
                    </Label>
                    <Switch
                      id="traffic"
                      ...
                      onCheckedChange={(checked) =>
                        updateSettings({ showTraffic: checked })
                      }
                    />
                  </div>
