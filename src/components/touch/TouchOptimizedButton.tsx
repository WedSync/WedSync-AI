...
export const PhotoCaptureButton: React.FC<
  Omit<TouchOptimizedButtonProps, 'priority' | 'context'>
> = (props) => (
  <TouchOptimizedButton priority="critical" context="photo" {...props} />
);

export const ClientContactButton: React.FC<
  Omit<TouchOptimizedButtonProps, 'priority' | 'context'>
> = (props) => (
  <TouchOptimizedButton priority="primary" context="client" {...props} />
);

export const ScheduleActionButton: React.FC<
  Omit<TouchOptimizedButtonProps, 'priority' | 'context'>
> = (props) => (
...
export const EmergencyButton: React.FC<
  Omit<TouchOptimizedButtonProps, 'priority' | 'context' | 'emergencyAction'>
> = (props) => (
