...
const inputVariants = cva(
  'flex w-full rounded-md border bg-white px-3 py-2 text-sm shadow-sm transition-colors file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-gray-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50',
  {
    variants: {
      variant: {
        default:
          'border-gray-300 focus-visible:border-brand-300 focus-visible:ring-brand-500',
        wedding:
          'border-rose-200 bg-rose-50/30 focus-visible:border-rose-300 focus-visible:ring-rose-500',
        elegant:
          'border-purple-200 bg-purple-50/30 focus-visible:border-purple-300 focus-visible:ring-purple-500',
        error:
          'border-red-300 bg-red-50 text-red-900 placeholder:text-red-300 focus-visible:border-red-500 focus-visible:ring-red-500',
        success:
          'border-green-300 bg-green-50 text-green-900 placeholder:text-green-300 focus-visible:border-green-500 focus-visible:ring-green-500',
        warning:
          'border-yellow-300 bg-yellow-50 text-yellow-900 placeholder:text-yellow-300 focus-visible:border-yellow-500 focus-visible:ring-yellow-500',
      },
      size: {
...
const Input = React.forwardRef<HTMLInputElement, InputProps>(
  (
    ...
    const touchOptimizedSize =
      props.onTouchStart && (size === 'xs' || size === 'sm') ? 'touch' : size;
