...
const mockUseGooglePlaces = useGooglePlaces as jest.MockedFunction<
  typeof useGooglePlaces
>;
...
describe('GooglePlacesAutocomplete Component', () => {
  ...
  describe('Search Functionality', () => {
    ...
    it('should display search predictions', async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText('Central Park Wedding Venue'),
        ).toBeInTheDocument();
    ...
    it('should show no results message', async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText('No venues found for "nonexistent venue"'),
        ).toBeInTheDocument();
        expect(
          screen.getByText('Try searching for a city, venue name, or address'),
        ).toBeInTheDocument();
      });
    });
  });
  ...
  describe('Keyboard Navigation', () => {
    ...
    it('should handle arrow down navigation', async () => {
      ...
      const firstOption = screen
        .getByText('Central Park Wedding Venue')
        .closest('button');
    ...
    it('should handle Escape key', async () => {
      ...
      await waitFor(() => {
        expect(
          screen.queryByText('Central Park Wedding Venue'),
  ...
  describe('Clear Functionality', () => {
    ...
    it('should clear input when clear button is clicked', async () => {
      ...
      render(
        <GooglePlacesAutocomplete value="test value" onChange={mockOnChange} />,
      );
  ...
  describe('External Value Control', () => {
    it('should sync with external value changes', () => {
      const { rerender } = render(
        <GooglePlacesAutocomplete value="initial value" />,
      );
