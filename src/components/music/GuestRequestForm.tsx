...
import { Music, Heart, Send, CheckCircle, AlertCircle } from 'lucide-react';
...
export default function GuestRequestForm({
  ...
  const handleChange = (
    field: keyof GuestRequestMusicRequest,
    value: string,
  ) => {
    setFormData((prev) => ({
      ...prev,
      ...
      <Card className="max-w-md mx-auto">
        <CardContent className="p-6 text-center">
          ...
          <p className="text-muted-foreground mb-4">
            Thank you for your song request! {coupleNames} will review it and
            may add it to their wedding playlist.
          </p>
    ...
    <Card className="max-w-md mx-auto">
      <CardHeader className="text-center">
        ...
        <p className="text-sm text-muted-foreground">
          Help make {coupleNames}' special day even more memorable by requesting
          a song for "{playlistName}"
        </p>
      </CardHeader>
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <p className="text-xs text-center text-muted-foreground">
            Your song request will be reviewed by {coupleNames}. Not all
            requests may be added to the final playlist.
          </p>
        </form>
      </CardContent>
    </Card>
