...
const searchSchema = z.object({
  ...
  genre: z
    ...
    .optional(),
  weddingPhase: z
    .enum(['ceremony', 'cocktails', 'dinner', 'dancing', 'pre_ceremony'])
    .optional(),
...
const WEDDING_PHASES = [
  { value: 'ceremony', label: 'Ceremony', emoji: '💒' },
  { value: 'cocktails', label: 'Cocktail Hour', emoji: '🍸' },
  { value: 'dinner', label: 'Dinner Service', emoji: '🍽️' },
  { value: 'dancing', label: 'Dance Floor', emoji: '💃' },
];
...
export function SongSearch({
  ...
  const [selectedProvider, setSelectedProvider] =
    useState<MusicProvider>('spotify');
    ...
    async (data: SearchFormData) => {
      ...
      try {
        ...
        if (results.success && results.data) {
          ...
          const transformedTracks = results.data.map(
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              {WEDDING_PHASES.map((phase) => (
                <button
                  ...
                  type="button"
                  onClick={() =>
                    setValue('weddingPhase', phase.value as WeddingPhase)
                  }
                  className={`
              ...
              <div className="space-y-6 pt-6 border-t border-gray-200">
                ...
                <div className="space-y-2">
                  <Label className="flex items-center gap-2">
                    ...
                    Energy Level: {watchedValues.energyRange[0]} -{' '}
                    {watchedValues.energyRange[1]}
                  </Label>
                  <Slider
                    value={watchedValues.energyRange}
                    onValueChange={(value) =>
                      setValue('energyRange', value as [number, number])
                    }
                    min={1}
                    max={10}
                    step={1}
                ...
                <div className="space-y-2">
                  <Label className="flex items-center gap-2">
                    ...
                    BPM: {watchedValues.bpmRange[0]} -{' '}
                    {watchedValues.bpmRange[1]}
                  </Label>
                  <Slider
                    value={watchedValues.bpmRange}
                    onValueChange={(value) =>
                      setValue('bpmRange', value as [number, number])
                    }
                    min={60}
                    max={180}
                    step={5}
                ...
                <div className="space-y-2">
                  <Label>
                    Duration (seconds): {watchedValues.durationMin} -{' '}
                    {watchedValues.durationMax}
                  </Label>
            ...
            {isSearching ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-500">
                  No results found for "{watchedValues.query}"
                </p>
