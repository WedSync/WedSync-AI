...
export function DomainPreview({
  ...
  const [previewType, setPreviewType] = useState<'portal' | 'website'>(
    'portal',
  );
    ...
    <div className={`space-y-6 ${className}`}>
      ...
      <div>
        ...
        <p className="text-sm text-gray-600">
          See how your {isCustomDomain ? 'custom domain' : 'default domain'}{' '}
          will look to your wedding clients
        </p>
      </div>
      ...
      <div className="flex items-center justify-between">
        <Tabs
          value={previewType}
          onValueChange={(value) =>
            setPreviewType(value as 'portal' | 'website')
          }
        >
        ...
        <Alert className="border-success-200 bg-success-25">
          ...
          <AlertDescription>
            <div className="text-success-700">
              ...
              <p className="text-sm">
                Your clients will see your professional domain, building trust
                and reinforcing your brand throughout their wedding planning
                journey.
              </p>
            </div>
          </AlertDescription>
        ...
        <Alert className="border-blue-200 bg-blue-25">
          ...
          <AlertDescription>
            <div className="text-blue-700">
              ...
              <p className="text-sm">
                Consider setting up a custom domain to enhance your professional
                image and build stronger client relationships with your own
                branded experience.
              </p>
            </div>
          </AlertDescription>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-4">
          ...
          <p className="text-xs text-gray-600">
            Beautiful galleries and portfolios displayed under your domain for
            maximum impact
          </p>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-4">
          ...
          <p className="text-xs text-gray-600">
            Timeline management, vendor coordination, and task tracking all
            under your brand
          </p>
        </div>
      </div>
  ...
  return (
    <div className="h-full p-6 space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-3">
          <div
            className={`w-8 h-8 ${isCustomDomain ? 'bg-primary-100' : 'bg-gray-200'} rounded-lg flex items-center justify-center`}
          >
            <Camera
              className={`h-4 w-4 ${isCustomDomain ? 'text-primary-600' : 'text-gray-500'}`}
            />
          </div>
          <div>
      ...
      <div className="flex justify-center items-center flex-1">
        <div
          className={`text-center ${isCustomDomain ? 'text-primary-600' : 'text-gray-400'}`}
        >
  ...
  return (
    <div className="h-full p-6 space-y-4">
      ...
      <div className="text-center space-y-2">
        <div
          className={`text-lg font-bold ${isCustomDomain ? 'text-primary-600' : 'text-gray-700'}`}
        >
      ...
      <div className="grid grid-cols-3 gap-2">
        {[1, 2, 3, 4, 5, 6].map((i) => (
          <div
            key={i}
            className="aspect-square bg-gray-200 rounded border"
          ></div>
        ))}
      </div>
