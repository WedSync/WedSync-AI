        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Manage your organization's custom domains, SSL certificates, and
                health monitoring
              </CardDescription>
            </div>
          ...
          {domains.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-muted-foreground mb-4">
                Add your first custom domain to get started with white-label
                branding
              </p>
                  ...
                  >
                        ...
                        {domain.unresolved_alerts_count > 0 && (
                          <div className="flex items-center gap-1 mt-1">
                            ...
                            <span className="text-xs text-orange-600">
                              {domain.unresolved_alerts_count} alert
                              {domain.unresolved_alerts_count !== 1 ? 's' : ''}
                            </span>
                          </div>
                        )}
                      </div>
                    ...
                    <TableCell>
                      <Badge
                        ...
                        className={cn(
                          'capitalize',
                          DOMAIN_STATUS_COLORS[domain.status],
                        )}
                      >
                        {domain.status}
                      </Badge>
                    ...
                    <TableCell>
                      {domain.health_status ? (
                        <Badge
                          ...
                          className={cn(
                            'capitalize',
                            HEALTH_STATUS_COLORS[domain.health_status],
                          )}
                        >
                          {domain.health_status}
                        </Badge>
                          ...
                          <>
                            ...
                            {domain.days_until_ssl_expiry !== undefined && (
                              <span
                                className={cn(
                                  'text-xs',
                                  domain.days_until_ssl_expiry < 30
                                    ? 'text-orange-600'
