    ...
    <div className={`space-y-6 ${className}`}>
      ...
      <div>
        ...
        <p className="text-sm text-gray-600">
          Add these DNS records to your domain registrar or DNS provider to
          complete the setup
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-4">
          ...
          <Badge
            className={`
            ${
              config.status.propagation_progress &&
              config.status.propagation_progress > 80
          ...
          <TabsContent value="txt" className="space-y-4 mt-4">
            {config.dns_records
              ...
              .map((record, index) => (
                <div
                  key={index}
                  className="bg-blue-25 border border-blue-200 rounded-lg p-4"
                >
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-2 mt-1">
                        ...
                        <Button
                          ...
                          size="sm"
                          onClick={() =>
                            copyToClipboard(record.name, `txt-name-${index}`)
                          }
                          className="h-6 w-6 p-0"
                        >
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-2 mt-1">
                        ...
                        <Button
                          ...
                          size="sm"
                          onClick={() =>
                            copyToClipboard(record.value, `txt-value-${index}`)
                          }
                          className="h-6 w-6 p-0"
                        >
          ...
          <TabsContent value="cname" className="space-y-4 mt-4">
            {config.dns_records
              ...
              .map((record, index) => (
                <div
                  key={index}
                  className="bg-green-25 border border-green-200 rounded-lg p-4"
                >
                  <div className="flex items-center space-x-2 mb-3">
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-2 mt-1">
                        ...
                        <Button
                          ...
                          size="sm"
                          onClick={() =>
                            copyToClipboard(record.name, `cname-name-${index}`)
                          }
                          className="h-6 w-6 p-0"
                        >
            ...
            <div className="space-y-6">
                ...
                <AlertDescription>
                  <div className="text-blue-700">
                    ...
                    <ol className="list-decimal list-inside space-y-2 text-sm">
                      ...
                      <li>
                        Save the changes and wait for DNS propagation (5-60
                        minutes)
                      </li>
                      <li>
                        Return to the Overview tab and click "Verify Domain"
                      </li>
                    </ol>
                  </div>
                </AlertDescription>
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {[
                    {
                      name: 'GoDaddy',
                      url: 'https://www.godaddy.com/help/manage-dns-records',
                    },
                    {
                      name: 'Cloudflare',
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                ...
                <ul className="text-sm text-yellow-700 space-y-1">
                  ...
                  <li>
                    • Some providers require "@" or blank value for root domain
                  </li>
                  <li>
                    • Contact your DNS provider if you're having trouble adding
                    records
                  </li>
                </ul>
              </div>
      ...
      <Alert className="border-primary-200 bg-primary-25">
        ...
        <AlertDescription>
          <div className="text-primary-700">
            ...
            <p className="text-sm">
              Once you've added these DNS records, our system will automatically
              detect the changes and provision your SSL certificate. This
              process usually takes 5-15 minutes after DNS propagation is
              complete.
            </p>
          </div>
        </AlertDescription>
