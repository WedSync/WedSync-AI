    ...
    try {
      ...
      const mockMetrics: PerformanceMetrics = {
        overall_score: Math.min(
          95,
          70 + profile.average_rating * 5 + profile.total_reviews * 0.5,
        ),
        delivery_score: 92,
        ...
        performance_trend:
          profile.average_rating > 4.2
            ? 'up'
            : profile.average_rating < 3.8
              ? 'down'
              : 'stable',
        recent_feedback: [
          {
            ...
            rating: 5,
            comment:
              'Absolutely wonderful service! Everything was perfect on our special day.',
            date: '2024-01-15',
          ...
          },
          {
            ...
            rating: 4,
            comment:
              'Great communication throughout the process. Very professional.',
            date: '2024-01-10',
          ...
          },
          {
            ...
            rating: 5,
            comment:
              'Exceeded our expectations! Highly recommend to other couples.',
            date: '2024-01-05',
    ...
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-600">
          Complete more weddings to see your performance metrics.
        </p>
      </div>
    );
  }
        ...
        <div className="flex items-end gap-8">
          <div className="flex-1">
            <div className="flex items-baseline gap-2">
              <span
                className={`text-4xl font-bold ${getScoreColor(performanceMetrics.overall_score)}`}
              >
            ...
            <p className="text-sm text-gray-600 mt-2">
              ...
              {performanceMetrics.performance_trend === 'down' &&
                'Trending downward ↘️'}
              {performanceMetrics.performance_trend === 'stable' &&
                'Stable performance →'}
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="p-4">
          ...
          <div className="flex items-baseline gap-1">
            <span
              className={`text-2xl font-bold ${getScoreColor(performanceMetrics.delivery_score)}`}
            >
          ...
          <Progress
            value={performanceMetrics.delivery_score}
            className="mt-2 h-2"
          />
        </Card>
        ...
        <Card className="p-4">
          ...
          <div className="flex items-baseline gap-1">
            <span
              className={`text-2xl font-bold ${getScoreColor(performanceMetrics.communication_score)}`}
            >
          ...
          <Progress
            value={performanceMetrics.communication_score}
            className="mt-2 h-2"
          />
        </Card>
        ...
        <Card className="p-4">
          ...
          <div className="flex items-baseline gap-1">
            <span
              className={`text-2xl font-bold ${getScoreColor(performanceMetrics.quality_score)}`}
            >
          ...
          <Progress
            value={performanceMetrics.quality_score}
            className="mt-2 h-2"
          />
        </Card>
        ...
        <Card className="p-4">
          ...
          <div className="flex items-baseline gap-1">
            <span
              className={`text-2xl font-bold ${getScoreColor(performanceMetrics.reliability_score)}`}
            >
          ...
          <Progress
            value={performanceMetrics.reliability_score}
            className="mt-2 h-2"
          />
        </Card>
      </div>
        ...
        <Card className="p-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <span className="font-semibold">
                  {performanceMetrics.on_time_delivery_rate}%
                </span>
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="font-semibold">
                {performanceMetrics.response_time_hours}h
              </span>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-1">
                ...
                <span className="font-semibold">
                  {(performanceMetrics.customer_satisfaction / 20).toFixed(1)}/5
                </span>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="font-semibold">
                {performanceMetrics.recommendation_rate}%
              </span>
            </div>
          </div>
        </Card>
        ...
        <Card className="p-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <span className="font-semibold">
                {performanceMetrics.completed_weddings}
              </span>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="font-semibold">
                {performanceMetrics.active_weddings}
              </span>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="font-semibold">
                £{performanceMetrics.total_revenue.toLocaleString()}
              </span>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="font-semibold">
                £{performanceMetrics.average_project_value.toLocaleString()}
              </span>
            </div>
                  ...
                  <div className="flex items-start justify-between mb-2">
                    <div>
                      <p className="font-medium text-gray-900">
                        {feedback.couple_names}
                      </p>
                      <p className="text-sm text-gray-500">
                        Wedding:{' '}
                        {new Date(feedback.wedding_date).toLocaleDateString()}
                      </p>
                    </div>
                    <div className="flex items-center gap-1">
      ...
      <Card className="p-6">
        ...
        {performanceMetrics.areas_for_improvement.length === 0 ? (
          ...
          <div className="space-y-3">
            {performanceMetrics.areas_for_improvement.map(
              (improvement, index) => (
                <div
                  key={index}
                  className="flex items-start gap-3 p-3 border border-orange-200 bg-orange-50 rounded-lg"
                >
