...
export function VendorCommunications() {
  ...
  const [selectedCommunication, setSelectedCommunication] =
    useState<VendorCommunication | null>(null);
      ...
      const mockCommunications: VendorCommunication[] = [
        {
          ...
          message:
            'Hi! We wanted to check on the status of our floral arrangements for next weekend. Everything still on track?',
          priority: 'normal',
          status: 'read',
          wedding_context: {
            wedding_id: 'w1',
        ...
        },
        {
          ...
          message:
            'All vendors - reminder that the final walkthrough is scheduled for tomorrow at 2pm. Please confirm attendance.',
          priority: 'high',
          status: 'delivered',
          wedding_context: {
            wedding_id: 'w2',
        ...
        },
        {
          ...
          message:
            'Timeline updated for the Johnson wedding. New vendor coordination meeting scheduled.',
          priority: 'normal',
          status: 'delivered',
          wedding_context: {
            wedding_id: 'w3',
  ...
  const filteredCommunications = communications.filter((comm) => {
    const matchesSearch =
      ...
      (comm.wedding_context?.couple_names
        .toLowerCase()
  ...
  const getStatusIcon = (status: string) => {
    switch (status) {
      ...
      case 'replied':
        return (
          <ChatBubbleBottomCenterTextIcon className="size-4 text-purple-500" />
        );
      default:
  ...
  const tabItems = [
    ...
    },
    {
      key: 'notifications',
      name: 'Notifications',
      count: communications.filter(
        (c) => c.type === 'notification' && c.status !== 'read',
      ).length,
    },
  ];
  ...
  return (
    <div className="space-y-6">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {comm.wedding_context && (
                      <p className="text-xs text-gray-500 mb-1">
                        ...
                        {new Date(
                          comm.wedding_context.wedding_date,
                        ).toLocaleDateString()}
                      </p>
                    )}
        ...
        <div className="space-y-4">
          {communications.filter((c) => c.is_group_message).length === 0 ? (
            <Card className="p-12 text-center">
              ...
              <p className="text-gray-600">
                Group conversations for specific weddings will appear here
              </p>
            </Card>
          ) : (
            communications
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600 mb-2">
                        <strong>{comm.from.business_name}:</strong>{' '}
                        {comm.message}
                      </p>
      ...
      {activeTab === 'notifications' && (
        <div className="space-y-4">
          {communications.filter((c) => c.type === 'notification').length ===
          0 ? (
            <Card className="p-12 text-center">
