...
const LAYOUT_TEMPLATES: LayoutTemplate[] = [
  {
    ...
    description:
      'Comprehensive layout for wedding planners managing multiple clients',
  ...
  },
  {
    ...
    name: 'Couple Simple',
    description:
      'Clean, simplified layout focused on wedding planning essentials',
  ...
  },
  {
    ...
    description:
      'Visual-focused layout for photographers showcasing their work',
  ...
  },
  {
    ...
    description:
      'Essential sections for wedding day coordination and management',
...
export function LayoutCustomizer({
  ...
  const [currentLayout, setCurrentLayout] =
    useState<LayoutConfiguration>(layout);
  ...
  const gridCellSize = useMemo(() => {
    const availableWidth =
      viewport.width -
      currentLayout.grid.gap * (currentLayout.grid.columns + 1);
    const cellWidth = availableWidth / currentLayout.grid.columns;

    const availableHeight =
      viewport.height - currentLayout.grid.gap * (currentLayout.grid.rows + 1);
  ...
  const updateSectionPosition = useCallback(
    (sectionType: SectionType, newPosition: LayoutSection['position']) => {
  ...
  const updateGridSettings = useCallback(
    (updates: Partial<LayoutConfiguration['grid']>) => {
      const updatedLayout = {
        ...currentLayout,
  ...
  const handleViewportChange = useCallback(
    (newViewport: keyof typeof VIEWPORT_SIZES) => {
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-gray-600">
            Design your perfect wedding dashboard layout
          </p>
        </div>
                        ...
                        return (
                          <div className="space-y-2">
                            <div className="text-xs text-blue-700">
                              Position: {section.position.x},{' '}
                              {section.position.y}
                            </div>
                            <div className="text-xs text-blue-700">
                              Size: {section.position.width} ×{' '}
              ...
              {Object.entries(VIEWPORT_SIZES).map(([key, size]) => {
                ...
                return (
                  <Button
                    ...
                    size="sm"
                    onClick={() =>
                      handleViewportChange(key as keyof typeof VIEWPORT_SIZES)
                    }
                  >
              ...
              >
                ...
                {!previewMode && (
                  <div className="absolute inset-0 pointer-events-none">
                    {Array.from({ length: currentLayout.grid.columns - 1 }).map(
                      (_, i) => (
                        <div
                          key={`col-${i}`}
                    ...
                    {Array.from({ length: currentLayout.grid.rows - 1 }).map(
                      (_, i) => (
                        <div
                          key={`row-${i}`}
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <ul className="text-sm text-pink-800 space-y-1">
                  <li>
                    • Keep essential sections like timeline and contacts easily
                    accessible
                  </li>
                  <li>• Hide financial information from guests for privacy</li>
                  <li>
                    • Use larger sections for complex information like vendor
                    details
                  </li>
                  <li>
                    • Design for mobile - 60% of users access on their phones
                  </li>
                  <li>
                    • Consider wedding day stress - simple layouts work better
                  </li>
                </ul>
              </div>
            </div>
