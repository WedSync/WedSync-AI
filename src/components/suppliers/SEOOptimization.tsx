...
export function SEOOptimization({
    ...
    try {
      ...
      if (!data.page_title) {
        issues.push({
          ...
          suggestion:
            'Add a compelling page title with your business name and service',
        });
        score -= 15;
        ...
        issues.push({
          ...
          suggestion:
            'Keep title under 60 characters for better display in search results',
        });
        score -= 5;
  ...
  const generateSuggestions = () => {
    ...
    toast({
      ...
      description:
        'SEO suggestions have been applied. Review and save the changes.',
    });
  };
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          ...
          <Button
            variant="outline"
            onClick={() => runSEOAnalysis(seoData)}
              ...
              {seoAnalysis.opportunities.length > 0 && (
                <div>
                  <h4 className="font-semibold text-blue-800 mb-2">
                    Opportunities ({seoAnalysis.opportunities.length})
                  </h4>
                  <div className="space-y-2">
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            The most important SEO elements for search rankings
          </CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            />
            <p className="text-xs text-muted-foreground">
              Appears as the clickable headline in search results. Keep under 60
              characters.
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              rows={3}
              className={
                seoData.meta_description.length > 160 ? 'border-red-500' : ''
              }
            />
            <p className="text-xs text-muted-foreground">
              Appears below your title in search results. Keep under 160
              characters.
            </p>
          </div>
        </CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Help search engines understand your services
          </CardDescription>
        </CardHeader>
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            How your profile appears when shared on social media
          </CardDescription>
        </CardHeader>
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="text-sm text-muted-foreground">
              <p className="mb-2">
                This schema markup helps search engines understand:
              </p>
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            How your profile will appear in Google search results
          </CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            How your profile will look when shared on social media
          </CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Essential items for optimal SEO performance
          </CardDescription>
        </CardHeader>
        ...
        <CardContent>
          <div className="space-y-3">
            ...
            <div className="flex items-center space-x-3">
              ...
              Object.keys(seoData.schema_markup).length > 0 ? (
                <CheckCircle className="w-5 h-5 text-green-600" />
              ) : (
                <X className="w-5 h-5 text-red-500" />
              )}
