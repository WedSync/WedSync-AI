...
const DOCUMENT_TYPES = [
  ...
  },
  {
    ...
    required: false,
    description: 'Professional licensing documents',
  },
  {
    value: 'certification',
  ...
  },
  {
    ...
    required: true,
    description: 'Company House registration or similar',
  },
  {
    value: 'other',
...
export function VerificationWorkflow({
  ...
  const handleFileUpload = async (file: File, documentType: string) => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/directory/suppliers/${profileId}/media`,
        {
          method: 'POST',
  ...
  const submitForVerification = async () => {
    ...
    const requiredTypes = DOCUMENT_TYPES.filter((type) => type.required).map(
      (type) => type.value,
    );
    ...
    if (missingTypes.length > 0) {
      toast({
        ...
        description: `Please upload: ${missingTypes
          .map((type) => DOCUMENT_TYPES.find((dt) => dt.value === type)?.label)
          .join(', ')}`,
        variant: 'destructive',
      });
      return;
    ...
    if (
      ...
      toast({
        ...
        description:
          'Please complete all required business verification fields.',
        variant: 'destructive',
      });
      return;
    }
    ...
    try {
      const response = await fetch(
        `/api/directory/suppliers/${profileId}/verify`,
        {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
  ...
  const calculateProgress = () => {
    ...
    const completedFields = businessFields.filter(
    ...
    if (
      verificationData.additional_info &&
      verificationData.additional_info.trim() !== ''
    ) {
      progress += 20;
    }
    ...
    <div className="space-y-6">
      {DOCUMENT_TYPES.map((docType, index) => {
        const uploadedDoc = documents.find(
          (doc: VerificationDocument) => doc.type === docType.value,
        );
        ...
        return (
          <Card
            key={index}
            className={
              isRequired && !uploadedDoc ? 'border-orange-200 bg-orange-50' : ''
            }
          >
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center justify-between p-3 border rounded-lg">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Button
                      ...
                      size="sm"
                      onClick={() =>
                        onRemoveDocument(documents.indexOf(uploadedDoc))
                      }
                    >
                      <X className="w-4 h-4" />
                    </Button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  onUpdate({ company_house_number: e.target.value })
                }
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  onUpdate({
                    contact_verification: {
                      ...businessInfo.contact_verification,
        ...
        <CardContent className="space-y-4">
          <div>
            <h4 className="font-semibold mb-2">
              Documents ({verificationData.documents.length})
            </h4>
          ...
          <div>
            ...
            <div className="space-y-1 text-sm text-muted-foreground">
              <p className="flex items-center">
                ...
                {
                  verificationData.business_verification.contact_verification
                    .email
                }
              </p>
              <p className="flex items-center">
            ...
            <div className="flex items-start space-x-3">
              ...
              <div className="text-yellow-800">
                ...
                <p className="text-sm">
                  ...
                  result. If approved, your profile will display a verified
                  badge.
                </p>
              </div>
            </div>
          ...
          <div className="bg-white rounded-lg p-4">
            ...
            <ul className="text-sm space-y-2 text-muted-foreground">
              <li className="flex items-start space-x-2">
                ...
                <span>
                  Our verification team will review your documents (1-2 days)
                </span>
              </li>
              <li className="flex items-start space-x-2">
                <div className="w-2 h-2 bg-blue-600 rounded-full mt-1.5"></div>
