...
import { Flower, CheckCircle2 } from 'lucide-react';
import { VendorSpecificScheduleViewProps } from './types';

export function FloristScheduleView({
  schedule,
  vendorData,
  onConfirmSchedule,
  onRequestChange,
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-gray-600 mb-4">
            Specialized floral arrangement schedule with installation timeline
