...
// Helper function to reorder fields with updated indices - EXTRACTED TO REDUCE NESTING
const reorderFieldsWithIndex = (fields: FormField[], oldIndex: number, newIndex: number): FormField[] => {
        ...
        setSections((prev) =>
          prev.map((section, idx) => {
            if (idx === activeSectionIndex) {
              ...
              return {
                ...section,
                fields: reorderFieldsWithIndex(section.fields, oldIndex, newIndex),
              };
            }
            return section;
          }),
              ...
              <div className="w-80 bg-white border-l overflow-y-auto">
                {selectedField ? (
                  <FieldEditor
                    field={selectedField}
                    onUpdate={(updates) =>
                      handleFieldEdit(selectedField.id, updates)
                    }
