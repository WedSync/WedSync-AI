...
const mockFieldIntegrationService = fieldIntegrationService as jest.Mocked<
  typeof fieldIntegrationService
>;
...
describe('FieldIntegration Component', () => {
  ...
  describe('Field Mapping', () => {
    it('shows no integration selected message initially', () => {
      ...
      expect(
        screen.getByText('Please connect and sync an integration source first'),
      ).toBeInTheDocument();
    });
  ...
  describe('Configuration Management', () => {
    it('shows empty state when no configurations exist', () => {
      ...
      expect(
        screen.getByText(
          'No configurations saved yet. Create field mappings to get started.',
        ),
      ).toBeInTheDocument();
    });
    ...
    it('displays saved integration configurations', async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText(/New api Integration Config/),
        ).toBeInTheDocument();
      });
    });
  });
  ...
  describe('Event Handlers', () => {
    it('calls onFieldsImported when fields are imported', async () => {
      ...
      render(
        <FieldIntegration
          {...defaultProps}
          onFieldsImported={onFieldsImported}
        />,
      );
  ...
  describe('Error Handling', () => {
    it('handles connection failures gracefully', async () => {
      ...
      await waitFor(() => {
        ...
        expect(
          screen.getByText('Field Integration Manager'),
        ).toBeInTheDocument();
      });
  ...
  describe('Accessibility', () => {
    ...
    it('supports keyboard navigation', async () => {
      ...
      expect(screen.getByText('Integration Sources')).toHaveAttribute(
        'data-state',
        'active',
      );
    });
