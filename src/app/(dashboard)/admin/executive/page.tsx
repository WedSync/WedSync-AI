...
export const metadata: Metadata = {
  ...
  description:
    'Executive-level analytics and business intelligence dashboard for WedSync platform performance.',
        ...
        <div className="mb-8">
          ...
          <div className="mt-4">
            ...
            <p className="mt-2 text-lg text-gray-600">
              Comprehensive business intelligence and strategic insights for
              WedSync platform performance.
            </p>
          </div>
        </div>
