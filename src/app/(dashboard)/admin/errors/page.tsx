...
export default function ErrorDashboard() {
  ...
  const getUrgencyIcon = (error: ErrorEvent) => {
    if (error.weddingContext?.urgency === 'critical')
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">
            Real-time error tracking and wedding impact analysis
          </p>
        </div>
                ...
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div>
                      ...
                      <Badge
                        className={`ml-2 ${getSeverityColor(selectedError.severity)}`}
                      >
                    ...
                    <div>
                      ...
                      {selectedError.endpoint || 'Unknown'}
                    </div>
                  </div>
                </div>
                  ...
                  <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      <div>
                        ...
                        {selectedError.weddingContext.vendorType}
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        {selectedError.weddingContext.urgency}
                      </div>
                      <div>
                        <strong>Client ID:</strong>{' '}
                        {selectedError.weddingContext.clientId || 'Unknown'}
                      </div>
                    </div>
                    {selectedError.weddingContext.weddingDate && (
