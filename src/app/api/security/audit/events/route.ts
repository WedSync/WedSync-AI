...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const securityValidation =
      await auditManager.validateSecurityContext(context);
    ...
    if (
      validatedEvent.celebrity_client ||
      validatedEvent.celebrity_tier === 'celebrity'
    ) {
    ...
    if (
      validatedEvent.severity === 'critical' ||
      validatedEvent.severity === 'high'
    ) {
