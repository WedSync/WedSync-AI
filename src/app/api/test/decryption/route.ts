...
export async function GET(request: NextRequest) {
  try {
    ...
    // Decrypt the data
    const decryptedName = await weddingEncryptionEngine.decryptField(
      testEncryptedData.guestName,
    );
    const decryptedEmail = await weddingEncryptionEngine.decryptField(
      testEncryptedData.email,
    );
    const decryptedPhone = await weddingEncryptionEngine.decryptField(
      testEncryptedData.phone,
    );
