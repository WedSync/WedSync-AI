...
export async function GET(
  ...
  try {
    ...
    const completedKeys = new Set(
      completedMilestones?.map((m) => m.milestone_key) || [],
    );
    ...
    const milestonesWithStatus =
      allMilestones?.map((milestone) => {
        ...
        const completion = completedMilestones?.find(
          (c) => c.milestone_key === milestone.milestone_key,
        );
  ...
  try {
    ...
    switch (action) {
      case 'complete_milestone':
        ...
        const result =
          await sectionVisibilityService.processMilestoneCompletion(
            id,
            milestone_key,
            completed_by,
            false,
      ...
      case 'process_timeline':
        ...
        const timelineResult =
          await sectionVisibilityService.processTimelineMilestones(
            id,
