  ...
  try {
    ...
    try {
      ...
      const eligibilityCheck =
        await feedbackFatigueService.checkFeedbackEligibility(
          user.id,
        ...
        return NextResponse.json(
          {
            ...
            message:
              "Thank you for your willingness to provide feedback. To ensure the best experience during your wedding journey, we've temporarily paused feedback collection.",
          },
          { status: 403 },
        );
      }
      ...
      const sessionRequest = {
        ...
        triggerReason:
          validatedData.context?.triggerReason || validatedData.triggerType,
        context: {
      ...
      const incentive = getSessionIncentive(
        validatedData.feedbackType,
        session.userType,
        session.userTier,
      );
      ...
      const fatigueAnalysis =
        await feedbackFatigueService.getFeedbackFatigueAnalysis(user.id);
      ...
      const response = {
        ...
        data: {
          ...
          sessionContext: {
            ...
            weddingProtections: eligibilityCheck.weddingContextRules,
            eligibilityScore:
              eligibilityCheck.skipReasons.length === 0 ? 'excellent' : 'good',
          },
        },
          ...
          return NextResponse.json(
            {
              ...
              message:
                'Thank you for your patience. Feedback collection is temporarily unavailable to ensure the best user experience.',
            },
            { status: 403 },
          );
        }
          ...
          return NextResponse.json(
            {
              ...
              details: serviceError.message,
              message:
                'To prevent feedback fatigue, please wait before requesting another feedback session.',
            },
            { status: 429 },
          );
        }
...
function getSessionIncentive(
    ...
    nps: {
      supplier: {
        free: {
          ...
          description: 'Early access to new supplier tools',
        },
        starter: {
        ...
        professional: {
          type: 'referral_bonus',
          description: '$50 credit for referrals',
        },
        scale: {
          type: 'custom_training',
          description: 'Free 1-on-1 platform training',
        },
        enterprise: {
          type: 'account_review',
          description: 'Quarterly business review session',
        },
      },
      couple: {
        free: {
          type: 'feature_preview',
          description: 'Early access to new planning tools',
        },
        starter: {
          type: 'priority_support',
          description: '30 days priority support',
        ...
        professional: {
          type: 'discount',
          description: '15% off premium features',
        },
        scale: {
          type: 'custom_planning',
          description: 'Free wedding planning consultation',
        },
        enterprise: {
          type: 'concierge_service',
          description: 'Dedicated wedding coordinator',
        },
      },
    },
    csat: {
      supplier: {
        free: {
          type: 'priority_support',
          description: '14 days priority support',
        },
        starter: {
          type: 'feature_preview',
          description: 'Beta access to upcoming features',
        },
        professional: {
        ...
        enterprise: {
          type: 'dedicated_success',
          description: 'Dedicated success manager check-in',
        },
      },
      couple: {
        free: {
        ...
        starter: {
          ...
          description: 'Free premium template pack',
        },
        professional: {
          type: 'discount',
          description: '10% off next billing cycle',
        },
        scale: {
          type: 'planning_tools',
          description: 'Free advanced planning tools for 60 days',
        },
        enterprise: {
          type: 'white_glove',
          description: 'White-glove setup assistance',
        },
      },
    },
    feature: {
      supplier: {
        free: {
          type: 'feature_preview',
          description: 'See your suggestion in development',
        },
        starter: {
          type: 'priority_support',
          description: '7 days priority support',
        },
        professional: {
          type: 'roadmap_influence',
          description: 'Vote on feature roadmap',
        },
        scale: {
          type: 'beta_access',
        ...
        enterprise: {
          type: 'custom_feature',
          description: 'Custom feature consideration',
        },
      },
      couple: {
        free: {
        ...
        professional: {
          ...
          description: 'Free template of choice',
        },
        scale: {
          type: 'planning_consultation',
          description: 'Free planning consultation',
        },
        enterprise: {
          type: 'custom_workflow',
          description: 'Custom workflow setup',
        },
      },
    },
    ...
    churn: {
      supplier: {
        free: {
          ...
          description: '3 months free Starter plan',
        },
        starter: {
          type: 'retention_offer',
          description: '2 months free Professional plan',
        },
        professional: {
          type: 'retention_offer',
          description: '1 month free Scale plan',
        },
        scale: {
          type: 'retention_call',
          description: 'Executive retention call',
        },
        enterprise: {
          type: 'custom_solution',
          description: 'Custom retention solution',
        },
      },
      couple: {
        free: {
          type: 'retention_offer',
          description: '6 months free premium features',
        },
        starter: {
          type: 'retention_offer',
          description: '3 months free upgrade',
        },
        professional: {
          type: 'retention_consultation',
          description: 'Free wedding consultation',
        },
        scale: {
          type: 'retention_call',
          description: 'Wedding planning expert call',
        },
        enterprise: {
          type: 'concierge_retention',
          description: 'Dedicated planning support',
        },
      },
    },
    general: {
      supplier: {
        ...
        scale: {
          ...
          description: 'Free training session',
        },
        enterprise: {
          type: 'success_review',
          description: 'Success manager review',
        },
      },
      couple: {
        free: {
        ...
        professional: {
          type: 'template_access',
          description: 'Free template pack',
        },
        scale: {
          type: 'planning_consultation',
        ...
        enterprise: {
          type: 'white_glove',
          description: 'Dedicated support session',
        },
      },
    },
  };
  ...
  try {
    const typeIncentives =
      incentiveMatrix[feedbackType as keyof typeof incentiveMatrix];
    if (!typeIncentives) return null;

    const userTypeIncentives =
      typeIncentives[userType as keyof typeof typeIncentives];
    if (!userTypeIncentives) return null;

    const tierIncentive =
      userTypeIncentives[userTier as keyof typeof userTypeIncentives];
