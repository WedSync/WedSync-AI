...
async function postHandler(
  ...
  try {
    ...
    const { feature_key, feature_name, time_saved_minutes, context_data } =
...
async function getHandler(
  ...
  try {
    ...
    const averageTimeSavedPerUsage =
      totalUsages > 0 ? totalTimeSaved / totalUsages : 0;
    ...
    return NextResponse.json({
      ...
      metrics: {
        ...
        average_time_saved_per_usage:
          Math.round(averageTimeSavedPerUsage * 100) / 100,
