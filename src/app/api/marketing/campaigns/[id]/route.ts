...
export async function PUT(
  ...
  try {
    ...
    if (segmentation_rules !== undefined)
      updateData.segmentation_rules = segmentation_rules;
    if (trigger_conditions !== undefined)
      updateData.trigger_conditions = trigger_conditions;
    if (schedule_settings !== undefined)
      updateData.schedule_settings = schedule_settings;
    if (workflow_config !== undefined)
      updateData.workflow_config = workflow_config;
    if (enable_ab_testing !== undefined)
      updateData.enable_ab_testing = enable_ab_testing;
