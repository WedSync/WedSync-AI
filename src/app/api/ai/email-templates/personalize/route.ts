...
type PersonalizeTemplateRequest = z.infer<
...
class EmailPersonalizationEngine {
  ...
  static personalizeTemplate(
    ...
    if (personalizationData.client_name) {
      replacements.set(
        '{{client_name}}',
        this.sanitizeContent(personalizationData.client_name),
      );
      replacements.set(
        '{{Client_Name}}',
        this.sanitizeContent(personalizationData.client_name),
      ...
      replacements.set(
        '{{CLIENT_NAME}}',
        this.sanitizeContent(personalizationData.client_name.toUpperCase()),
      );
    }
    ...
    if (personalizationData.partner_name) {
      replacements.set(
        '{{partner_name}}',
        this.sanitizeContent(personalizationData.partner_name),
      );
      replacements.set(
        '{{Partner_Name}}',
        this.sanitizeContent(personalizationData.partner_name),
    ...
    if (personalizationData.wedding_date) {
      const formattedDate = this.formatWeddingDate(
        personalizationData.wedding_date,
      );
    ...
    if (personalizationData.venue_name) {
      replacements.set(
        '{{venue_name}}',
        this.sanitizeContent(personalizationData.venue_name),
      );
      replacements.set(
        '{{Venue_Name}}',
        this.sanitizeContent(personalizationData.venue_name),
    ...
    if (personalizationData.vendor_name) {
      replacements.set(
        '{{vendor_name}}',
        this.sanitizeContent(personalizationData.vendor_name),
      );
      replacements.set(
        '{{Vendor_Name}}',
        this.sanitizeContent(personalizationData.vendor_name),
    ...
    if (personalizationData.contact_phone) {
      replacements.set(
        '{{contact_phone}}',
        this.sanitizeContent(personalizationData.contact_phone),
      );
    }
    ...
    if (personalizationData.contact_email) {
      replacements.set(
        '{{contact_email}}',
        this.sanitizeContent(personalizationData.contact_email),
      );
    }
    ...
    if (personalizationData.guest_count) {
      replacements.set(
        '{{guest_count}}',
        this.sanitizeContent(personalizationData.guest_count),
      );
    }
    ...
    if (personalizationData.event_time) {
      replacements.set(
        '{{event_time}}',
        this.sanitizeContent(personalizationData.event_time),
      );
    }
    ...
    if (personalizationData.special_requests) {
      replacements.set(
        '{{special_requests}}',
        this.sanitizeContent(personalizationData.special_requests),
      );
    }
    ...
    if (personalizationData.budget_range) {
      replacements.set(
        '{{budget_range}}',
        this.sanitizeContent(personalizationData.budget_range),
      );
    }
    ...
    if (personalizationData.preferred_style) {
      replacements.set(
        '{{preferred_style}}',
        this.sanitizeContent(personalizationData.preferred_style),
      );
    }
    ...
    if (personalizationData.timeline_stage) {
      replacements.set(
        '{{timeline_stage}}',
        this.sanitizeContent(personalizationData.timeline_stage),
      );
    }
    ...
    if (personalizationData.next_step) {
      replacements.set(
        '{{next_step}}',
        this.sanitizeContent(personalizationData.next_step),
      );
    }

    // Custom fields
    if (personalizationData.custom_fields) {
      Object.entries(personalizationData.custom_fields).forEach(
        ([key, value]) => {
    ...
    personalizedBody = this.processConditionalContent(
      personalizedBody,
      personalizationData,
    );
...
async function personalizeTemplateHandler(
  ...
  try {
    ...
    if (validatedData.clientId) {
      ...
      if (
        !validatedData.personalizationData.partner_name &&
        client.partner_name
      ) {
