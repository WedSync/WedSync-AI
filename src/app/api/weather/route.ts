  ...
  try {
    ...
    switch (type) {
      ...
      case 'forecast':
        ...
        response = await weatherService.getWeatherForecast(
          latitude,
          longitude,
          days,
        );
      ...
      case 'wedding':
        ...
        response = await weatherService.getWeatherForWeddingDate(
          latitude,
          longitude,
          weddingDate,
        );
      ...
      case 'analysis':
        ...
        response = await weatherService.analyzeWeatherRisk(
          latitude,
          longitude,
          weddingDate,
          isOutdoor,
        ...
        return NextResponse.json(
          {
            success: false,
            error:
              'Invalid weather type. Supported types: current, forecast, wedding, analysis',
            timestamp: new Date().toISOString(),
          },
          { status: 400 },
        );
