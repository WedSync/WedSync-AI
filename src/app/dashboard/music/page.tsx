...
export default function MusicPage() {
  ...
  return (
    <div
      ...
      data-testid="music-dashboard-container"
    >
      {/* Page Header */}
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-2">
                AI-powered music search and wedding appropriateness analysis for
                professional DJs
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          >
            <Card className="cursor-pointer hover:shadow-md transition-shadow">
              <CardHeader className="pb-4">
                ...
                <CardDescription>
                  Search across multiple music providers with AI-powered
                  filtering
                </CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-gray-600 mb-4">
                  Find the perfect songs for every wedding moment with
          ...
          >
            <Card className="cursor-pointer hover:shadow-md transition-shadow">
              ...
              <CardContent>
                <p className="text-sm text-gray-600 mb-4">
                  Handle client requests like "that romantic song by Bruno Mars"
                  with AI assistance.
                </p>
                <div className="flex flex-wrap gap-2">
          ...
          >
            <Card className="cursor-pointer hover:shadow-md transition-shadow">
              ...
              <CardContent>
                <p className="text-sm text-gray-600 mb-4">
                  Build complete wedding timelines with energy flow
                  optimization.
                </p>
                <div className="flex flex-wrap gap-2">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <Badge variant="outline">
                        {selectedTrack.primary_genre}
                      </Badge>
                      <Badge variant="outline">
                        Energy: {selectedTrack.energy_level}/10
                      </Badge>
                      <Badge
                        variant={
                          selectedTrack.wedding_appropriateness === 'perfect'
                            ? 'default'
                            : 'secondary'
                        }
                      >
