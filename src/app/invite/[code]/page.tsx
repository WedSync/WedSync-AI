...
async function getInvitationData(code: string, searchParams: any) {
  ...
  if (searchParams.utm_source)
    url.searchParams.set('utm_source', String(searchParams.utm_source));
  if (searchParams.utm_medium)
    url.searchParams.set('utm_medium', String(searchParams.utm_medium));
  if (searchParams.utm_campaign)
    url.searchParams.set('utm_campaign', String(searchParams.utm_campaign));
  if (searchParams.session_id)
    url.searchParams.set('session_id', String(searchParams.session_id));
...
export async function generateMetadata({
  ...
  const description =
    invitation.personalized_message ||
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              invitation.personalized_message ||
              'Join your personalized wedding dashboard',
