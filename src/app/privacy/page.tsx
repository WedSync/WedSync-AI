...
export const metadata = {
  title: 'Privacy Policy - WedSync',
  description:
    'Learn how WedSync protects your wedding planning data and respects your privacy',
};
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground">
            Your privacy is fundamental to everything we do at WedSync
          </p>
        ...
        <div className="bg-blue-50 rounded-lg p-6 mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-2 text-sm">
            ...
            <Link href="#data-usage" className="text-blue-600 hover:underline">
            ...
            <Link href="#your-rights" className="text-blue-600 hover:underline">
              → Your Privacy Rights
            </Link>
            <Link
              href="#data-security"
        ...
        <div className="space-y-8">
          ...
          <section className="prose prose-gray max-w-none">
            <p className="text-lg leading-relaxed">
              WedSync ("we," "our," or "us") is committed to protecting your
              privacy and ensuring the security of your personal information.
              This Privacy Policy explains how we collect, use, disclose, and
              safeguard your information when you use our wedding planning
              platform.
            </p>
          </section>
            ...
            <div className="pl-7 space-y-4">
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 text-gray-600">
                  ...
                  <li>Wedding date, venue, and location details</li>
                  <li>
                    Guest information (names, addresses, dietary requirements)
                  </li>
              ...
              <div>
                <h3 className="font-semibold mb-2">Sensitive Information</h3>
                <p className="text-gray-600">
                  We may process dietary restrictions, accessibility needs, and
                  health-related information for your guests only when necessary
                  for wedding planning purposes and with explicit consent.
                </p>
              </div>
            </div>
          </section>
          ...
          <section id="data-sharing" className="space-y-4">
            ...
            <div className="pl-7 space-y-4">
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 text-gray-600">
                  <li>Vendors you explicitly choose to work with</li>
                  <li>Guests you invite to your wedding</li>
                  <li>Wedding party members you designate</li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600">
                  When required by law, court order, or to protect rights and
                  safety.
                </p>
              </div>
          ...
          <section id="your-rights" className="space-y-4">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h2 className="text-2xl font-semibold">4. Your Privacy Rights</h2>
            </div>
            ...
            <div className="pl-7 space-y-4">
              ...
              <p className="text-gray-600">
                ...
                or contact us at privacy@wedsync.com
              </p>
            </div>
          </section>
          ...
          <section id="cookies" className="space-y-4">
            ...
            <div className="pl-7 space-y-3">
              ...
              <p className="text-gray-600 mt-3">
                You can manage cookie preferences through our{' '}
          ...
          <section id="gdpr" className="space-y-4">
            ...
            <div className="pl-7 space-y-4">
              <div>
                <h3 className="font-semibold mb-2">For EU Residents (GDPR)</h3>
              ...
              <div>
                ...
                <p className="text-gray-600">
                  You have additional rights including the right to know what
                  personal information we collect, the right to delete, and the
                  right to opt-out of the sale of personal information (which we
                  do not do).
                </p>
              </div>
            </div>
          ...
          <section className="space-y-4">
            ...
            <div className="pl-7">
              <p className="text-gray-600">
                ...
                our services and comply with legal obligations. After your
                wedding date, we retain data for:
              </p>
              <ul className="list-disc list-inside space-y-1 text-gray-600 mt-2">
                <li>Active account data: As long as your account is active</li>
                <li>Transactional records: 7 years for tax purposes</li>
                <li>Marketing data: Until you unsubscribe</li>
                <li>
                  Deleted account data: 30 days recovery period, then permanent
                  deletion
                </li>
              </ul>
            </div>
          ...
          <section className="space-y-4">
            ...
            <p className="text-gray-600">
              ...
              Policy on this page and updating the "Last Updated" date. For
          ...
          <section id="contact" className="space-y-4">
            ...
            <div className="pl-7 space-y-3">
              ...
              <div className="bg-gray-50 rounded-lg p-4 space-y-2">
                <p>
                  <strong>Email:</strong> privacy@wedsync.com
                </p>
                <p>
                  <strong>Data Protection Officer:</strong> dpo@wedsync.com
                </p>
                <p>
                  <strong>Address:</strong> WedSync Inc., 123 Wedding Lane, San
                  Francisco, CA 94105
                </p>
                <p>
                  <strong>Phone:</strong> 1-800-WEDSYNC
                </p>
              </div>

              <p className="text-gray-600">
                For privacy-related requests, you can also use our{' '}
                <Link
                  href="/privacy/settings"
                  className="text-primary hover:underline"
                >
          ...
          <div className="border-t pt-8 mt-12">
            <div className="flex flex-wrap gap-4 text-sm text-gray-600">
              ...
              <Link href="/privacy/settings" className="hover:text-primary">
                Privacy Settings
              </Link>
            ...
            <p className="text-xs text-gray-500 mt-4">
              © {new Date().getFullYear()} WedSync. All rights reserved. This
