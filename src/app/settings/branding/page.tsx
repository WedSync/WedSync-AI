    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex items-center space-x-3">
          ...
          <Button variant="ghost" onClick={resetTheme} disabled={saving}>
            Reset to Default
          </Button>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card className="p-6">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Choose a preset that matches your photography style, then
              customize further below.
            </p>
          ...
          <Card className="p-6">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Upload your business logo to appear on client forms, emails, and
              communications.
            </p>
          ...
          <Card className="p-6">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Customize your primary and secondary colors to match your brand
              identity.
            </p>
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center space-x-3">
                  <input
                    ...
                    onChange={(e) =>
                      updateTheme({ secondary_color: e.target.value })
                    }
                    className="w-12 h-12 rounded-lg border border-gray-300 cursor-pointer"
                    disabled={saving}
                  />
          ...
          <Card className="p-6">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Add custom CSS to further personalize your client portal
              appearance.
            </p>
        ...
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <ul className="text-sm text-purple-700 space-y-1">
              <li>
                • Use elegant, readable fonts that reflect your photography
                style
              </li>
              <li>
                • Choose colors that complement rather than compete with wedding
                photos
              </li>
              ...
              <li>
                • Your branding appears on client forms, emails, and all
                communications
              </li>
            </ul>
          </div>
