        ...
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              Connect with Apple Calendar using CalDAV protocol for seamless
          ...
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <p className="text-sm text-blue-600">
                Sync with your iPhone calendar app and get Siri notifications
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <p className="text-sm text-purple-600">
                Access wedding schedules on your Mac and iPad Calendar apps
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <p className="text-sm text-green-600">
                Get wedding appointment reminders on your Apple Watch
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-amber-700">
              <p>
                This integration uses Apple's secure CalDAV protocol with
                app-specific passwords. Your main Apple ID password is never
                stored or transmitted. All calendar data is encrypted in transit
                using HTTPS/TLS.
              </p>
            </div>
          </div>
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-blue-700">
              <p className="mb-2">
                To connect your Apple Calendar, you'll need:
              </p>
              <ol className="list-decimal list-inside space-y-1">
                <li>Your Apple ID email address</li>
                <li>
                  An app-specific password (generated from appleid.apple.com)
                </li>
              ...
              <p className="mt-2">
                ...
                >
                  Learn how to create an app-specific password →
                </a>
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <ul className="text-sm text-purple-700 space-y-1">
              <li>• Client consultations will sync as "Client Meeting"</li>
              <li>• Venue visits appear as "Venue Visit"</li>
              <li>• Wedding ceremonies are marked "Wedding Ceremony"</li>
              <li>• Reception events show as "Wedding Reception"</li>
            </ul>
          </div>
          <div>
            <h4 className="text-sm font-medium text-purple-800 mb-2">
            ...
            <ul className="text-sm text-purple-700 space-y-1">
              <li>• Book appointments on your iPhone on-the-go</li>
              <li>• Get Apple Watch notifications for wedding day timeline</li>
              <li>• Use Siri to check your wedding schedule</li>
              <li>• Access maps and driving directions from Calendar app</li>
            </ul>
          </div>
        </div>
      </div>
        ...
        <div className="mt-4 space-y-4">
          <div>
            ...
            <ul className="mt-1 text-sm text-gray-600 space-y-1">
              ...
              <li>
                • Generate a fresh app-specific password if authentication fails
              </li>
              <li>
                • Check that your Apple ID hasn't been locked or suspended
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul className="mt-1 text-sm text-gray-600 space-y-1">
              <li>
                • Events may take up to 15 minutes to appear across devices
              </li>
              <li>• Check your internet connection and iCloud status</li>
              <li>• Restart the Calendar app on your devices after setup</li>
            </ul>
          </div>
        </div>
