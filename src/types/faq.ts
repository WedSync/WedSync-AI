...
export interface UpdateFaqCategoryRequest
  extends Partial<CreateFaqCategoryRequest> {
  id: string;
  is_active?: boolean;
}
...
export const WEDDING_FAQ_CATEGORIES = [
  ...
  },
  {
    ...
    icon: 'Package',
    description:
      'Available packages, add-on services, and customization options',
  },
  {
...
export type WeddingFaqCategorySlug =
  (typeof WEDDING_FAQ_CATEGORIES)[number]['slug'];
