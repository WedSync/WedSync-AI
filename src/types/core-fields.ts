...
export function detectCoreFieldFromLabel(label: string): {
  ...
  const patterns: Array<{
    ...
    // Bride patterns
    {
      pattern: /bride.*first.*name|her.*first.*name/,
      field_key: 'bride_first_name',
      confidence: 0.9,
    },
    {
      pattern: /bride.*last.*name|her.*last.*name/,
      field_key: 'bride_last_name',
      confidence: 0.9,
    },
    {
      pattern: /bride.*email|her.*email/,
      field_key: 'bride_email',
      confidence: 0.85,
    },
    {
      pattern: /bride.*phone|her.*phone/,
      field_key: 'bride_phone',
      confidence: 0.85,
    },
    {
      pattern: /bride.*name|her.*name/,
      field_key: 'bride_first_name',
      confidence: 0.8,
    },
    ...
    // Groom patterns
    {
      pattern: /groom.*first.*name|his.*first.*name/,
      field_key: 'groom_first_name',
      confidence: 0.9,
    },
    {
      pattern: /groom.*last.*name|his.*last.*name/,
      field_key: 'groom_last_name',
      confidence: 0.9,
    },
    {
      pattern: /groom.*email|his.*email/,
      field_key: 'groom_email',
      confidence: 0.85,
    },
    {
      pattern: /groom.*phone|his.*phone/,
      field_key: 'groom_phone',
      confidence: 0.85,
    },
    {
      pattern: /groom.*name|his.*name/,
      field_key: 'groom_first_name',
      confidence: 0.8,
    },
    ...
    // Timeline patterns
    {
      pattern: /getting.*ready.*time/,
      field_key: 'getting_ready_time',
      confidence: 0.9,
    },
    {
      pattern: /first.*look.*time/,
      field_key: 'first_look_time',
      confidence: 0.9,
    },
    {
      pattern: /cocktail.*hour/,
      field_key: 'cocktail_hour_time',
      confidence: 0.85,
    },
    ...
    {
      pattern: /cake.*cutting/,
      field_key: 'cake_cutting_time',
      confidence: 0.85,
    },
    {
      pattern: /send.*off.*time|departure/,
      field_key: 'send_off_time',
      confidence: 0.85,
    },
  ];
  ...
  switch (field.field_type) {
    ...
    case 'number':
      ...
      if (field.validation_rules?.min && num < field.validation_rules.min) {
        return {
          valid: false,
          error: `Minimum value is ${field.validation_rules.min}`,
        };
      }
      if (field.validation_rules?.max && num > field.validation_rules.max) {
        return {
          valid: false,
          error: `Maximum value is ${field.validation_rules.max}`,
        };
      }
      break;
