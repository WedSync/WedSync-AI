...
export interface UpdateReceptionTableInput
  extends Partial<CreateReceptionTableInput> {
  id: string;
}
...
export interface UpdateGuestRelationshipInput
  extends Partial<CreateGuestRelationshipInput> {
  id: string;
}
...
export function isValidSeatingPreference(
  value: string,
): value is SeatingPreference {
  return [
    'must_sit_together',
    'prefer_together',
    'neutral',
