...
export interface CustomerHealthInsert
  extends Omit<
    CustomerHealthRow,
...
export interface SuccessMilestoneInsert
  extends Omit<SuccessMilestoneRow, 'id' | 'created_at' | 'updated_at'> {
  id?: string;
  created_at?: string;
  updated_at?: string;
}

export interface SuccessMilestoneUpdate
  extends Partial<SuccessMilestoneInsert> {}
...
export interface SupportInteractionInsert
  extends Omit<SupportInteractionRow, 'id' | 'created_at' | 'updated_at'> {
  id?: string;
  created_at?: string;
  updated_at?: string;
}

export interface SupportInteractionUpdate
  extends Partial<SupportInteractionInsert> {}
