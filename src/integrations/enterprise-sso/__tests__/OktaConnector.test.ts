...
describe('OktaConnector', () => {
  ...
  describe('OAuth2 Flow', () => {
    it('should generate correct authorization URL', () => {
      ...
      expect(authUrl).toContain(
        `https://${mockConfig.domain}/oauth2/v1/authorize`,
      );
    ...
    it('should exchange authorization code for tokens', async () => {
      ...
      const result = await oktaConnector.exchangeCodeForTokens(
        'auth-code',
        'state',
      );
  ...
  describe('User Profile Management', () => {
    ...
    it('should update user profile', async () => {
      ...
      const result = await oktaConnector.updateUserProfile(
        'okta-user-123',
        updates,
      );
  ...
  describe('Passwordless Authentication', () => {
    ...
    it('should verify passwordless authentication', async () => {
      ...
      const result = await oktaConnector.verifyPasswordlessAuth(
        'factor-id',
        'verification-code',
      );
  ...
  describe('Group Management', () => {
    ...
    it('should assign user to group', async () => {
      ...
      const result = await oktaConnector.assignUserToGroup(
        'okta-user-123',
        'group-1',
      );
  ...
  describe('Session Management', () => {
    it('should create session from token', async () => {
      ...
      const session =
        await oktaConnector.createSessionFromToken('session-token-123');
