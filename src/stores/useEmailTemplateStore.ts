      ...
      persist(
        (set, get) => ({
          ...
          removeVariant: (variantId) => {
            set((state) => ({
              generatedVariants: state.generatedVariants.filter(
                (v) => v.id !== variantId,
              ),
              selectedVariant:
                state.selectedVariant?.id === variantId
          ...
          duplicateVariant: (variantId) => {
            set((state) => {
              const variant = state.generatedVariants.find(
                (v) => v.id === variantId,
              );
          ...
          removePersonalizationRule: (ruleId) => {
            set((state) => ({
              personalizationRules: state.personalizationRules.filter(
                (r) => r.id !== ruleId,
              ),
              isDirty: true,
            }));
          ...
          removeVariantComparison: (variantAId, variantBId) => {
            set((state) => ({
              variantComparisons: state.variantComparisons.filter(
                (c) =>
                  !(
                    c.variant_a_id === variantAId &&
                    c.variant_b_id === variantBId
                  ),
              ),
            }));
          },
            ...
            set((state) => ({
              generationConfig: state.generationConfig
                ? {
                    ...
                    client_context: {
                      ...state.generationConfig.client_context,
                      ...context,
                    },
                  }
                : null,
            ...
            set((state) => ({
              generationConfig: state.generationConfig
                ? {
                    ...state.generationConfig,
                    vendor_context: {
                      ...state.generationConfig.vendor_context,
                      ...context,
                    },
                  }
                : null,
...
export const initializeWithDefaults = (
