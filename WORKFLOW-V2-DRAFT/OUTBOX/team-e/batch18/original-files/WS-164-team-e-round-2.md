# TEAM E - ROUND 2: WS-164 - Manual Budget Tracking - Enhancement - OCR, installments, alerts
...
### Code Files:
- Tests: /wedsync/tests/integration/expense-tracking.test.ts
- Specs: /wedsync/tests/integration/expense-workflow.spec.ts
